...
def get_args():
    ...
    parser.add_argument("-s", action="store_true", help="Separate barcode and "
                        "'property of' to allow them to be cut up")
    return parser.parse_args()


def generate_label(part_code, separate):
    left_margin = 32
    msg_gap = 20 if separate else 0
    ...
    label_width = barcode_width+left_margin+113+msg_gap
    ...
    msg_start_position = barcode_width + left_margin + msg_gap
    msg1_position = (msg_start_position + 10, 3)
    msg2_position = (msg_start_position + 23, 22)
    msg3_position = (msg_start_position + 20, 40)
...
if __name__ == "__main__":
    ...
    label = generate_label(partcode, args.s)
